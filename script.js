...
if (x<148 && y==50)
...
else if(x>125 && y==140)
	{
		...
		context.drawImage(tileSheet, sourceX, sourceY,32,32,-5,-80,32,32);
...
else if(x==125 && y<201)
	{
		...
		context.drawImage(tileSheet, sourceX, sourceY,32,32,45,-5,32,32);
...
else if(x<225 && y==201)
	{
		...
		context.drawImage(tileSheet, sourceX, sourceY,32,32,-25,48,32,32);
	...
	context.drawImage(tileSheet, sourceX, sourceY,32,32, 50,-10,32,32);
	context.restore();
	}
else if(x>192 && y==262)
	{
		...
		context.drawImage(tileSheet, sourceX, sourceY,32,32,-9,-80,32,32);
